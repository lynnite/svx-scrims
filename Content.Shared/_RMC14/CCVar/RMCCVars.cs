...
public sealed partial class RMCCVars : CVars
{
    ...
    public static readonly CVarDef<float> CMMarinesPerXeno =
        CVarDef.Create("rmc.marines_per_xeno", 0.05f, CVar.SERVER | CVar.SERVERONLY);
    ...
    public static readonly CVarDef<int> RMCPlanetMapVoteExcludeLast =
        CVarDef.Create("rmc.planet_map_vote_exclude_last", 4, CVar.SERVER | CVar.SERVERONLY);
    ...
    public static readonly CVarDef<int> RMCDistressXenosMinimum =
        CVarDef.Create("rmc.distress_xenos_minimum", 1, CVar.REPLICATED | CVar.SERVER);
